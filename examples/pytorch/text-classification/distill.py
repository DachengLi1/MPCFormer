...
def main():
    ...
    parser.add_argument("--hard_ratio",
                        default=0,
                        type=float,
                        help="loss ratio for hard target.")
    ...
    default_params = {
        "cola": {"num_train_epochs": 80, "max_seq_length": 128},
        ...
        "sts-b": {"num_train_epochs": 50, "max_seq_length": 128},
    ...
    if args.do_eval:
        ...
        #loss_hard = None
        #teacher_config = json.load(open(os.path.join(args.teacher_dir, "config.json"), "r"))
        ...
        for epoch_ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration", ascii=True)):
                ...
                if input_ids.size()[0] != args.train_batch_size:
                    continue
                # experiment: delete mask
                if args.train_batch_size == 1:
                    actual_length = seq_lengths.item()
#                    print(segment_ids.shape)
                    input_ids = input_ids[:, :actual_length]
                    input_mask = input_mask[:, :actual_length]
                    segment_ids = segment_ids[:, :actual_length]
