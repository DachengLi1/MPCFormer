...
def main():
    ...
    #    print(f"{name}: {param}")
        if "query.weight" in name:
            query_mean.append(torch.mean(param).item())
            query_std.append(torch.std(param).item())
        if "key.weight" in name:
            key_mean.append(torch.mean(param).item())
            key_std.append(torch.std(param).item())
        if "value.weight" in name:
            value_mean.append(torch.mean(param).item())
            value_std.append(torch.std(param).item())
        if "dense.weight" in name:
            dense_mean.append(torch.mean(param).item())
            dense_std.append(torch.std(param).item())
